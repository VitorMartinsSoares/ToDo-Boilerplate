...
interface IExampleDetail extends IDefaultDetailProps {
	...
	mudar:(id: any, callback: any) =>void;
}

const  ExampleDetail = (props: IExampleDetail) => {
	const { isPrintView, screenState, loading, exampleDoc, save, navigate,mudar } = props;
	...
	const handleMudar = () =>{
		mudar(exampleDoc._id,(e: IMeteorError,r: string)=>{
			console.log("Error",e);
		...
		<PageLayout
			...
			<SimpleForm
				...
				<FormGroup key={'fieldsOne'}>
					...
					<SelectField placeholder="teste" name='opcoes' />
				</FormGroup>
...
export const ExampleDetailContainer = withTracker((props: IExampleDetailContainer) => {
	...
	return {
		screenState,
		exampleDoc,
		mudar:(id:any,callback:any)=>exampleApi.mudarTituloEDescricao (id,callback),
